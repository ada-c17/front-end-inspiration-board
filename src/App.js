    ...
    <div>
      ...
      <main>
        ...
        <select className={showCardForm} onChange={handleSortSelection}>
          ...
          <option value="plusOneUp">&#8657; Likes &#8657;</option>
          <option value="plusOneDown">&#8595; Likes &#8595;</option>
          <option value="messageUp">&#8657; Wish message &#8657;</option>
          <option value="messageDown">&#8595; Wish message &#8595;</option>
        </select>
        <CardList
          cards={cardData}
